...
public class GroupMembershipHandler : HandlerBase<GroupMembershipHandler, DataContext>
{
    public GroupMembershipHandler(DataContext context, ILogger<GroupMembershipHandler> logger) 
        : base(context, logger)
    {
    }
