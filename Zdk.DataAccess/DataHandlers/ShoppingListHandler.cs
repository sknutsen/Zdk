...
public class ShoppingListHandler : HandlerBase<ShoppingListHandler, ShoppingListContext>
{
    public ShoppingListHandler(ShoppingListContext context, ILogger<ShoppingListHandler> logger) 
        : base(context, logger)
    {
    }
